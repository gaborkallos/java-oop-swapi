...
public class PeopleController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String url = request.getParameter("character");
        if (url != null) {
            ...
            try {
                ...
                People character = mapper.readValue(contentAsString, People.class);
                httpClient.stop();
                context.setVariable("character", character);
                engine.process("character.html", context, response.getWriter());
            } catch (Exception e) {
                e.printStackTrace();
            }
        } else {
